...
export default function PostPreview(props: PostMetadata) {
    ...
    return (
        ...
        <div className="md:flex md:[&>*]:hover:-translate-x-3 md:[&>*]:hover:transition-transform md:[&>*]:hover:duration-400">
            <div className="w-full border border-slate-200 bg-white p-4 rounded-md shadow-md md:flex
                            dark:border-gray-700 dark:bg-gray-900">
                <div className="md:mr-4 md:w-24 md:h-24">
                    <Image
                        className="object-cover w-full md:w-24 md:h-24"
                        src={`/blog-images/${props.image}`}
                        alt="Topic photo"
                        width={180}
                        height={180}
                        priority
                ...
                <div className="md:flex-1">
                    <p className="font-bold hover:underline text-slate-900 dark:text-white">
                        {props.title}
                    </p>
