    ...
    return (
        ...
        <div className="flex w-full items-end justify-center via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto">
            ...
            <div className="pointer-events-auto flex place-items-center gap-2 p-2 lg:pointer-events-auto">
                <Link href={"/"} className="bg-transparent text-black px-4 py-2 rounded-lg hover:bg-gray-200 transition dark:text-white">
                    Home
                </Link>
                <Link href={"/blog"} className="bg-transparent text-black px-4 py-2 rounded-lg hover:bg-gray-200 transition dark:text-white">
                    Blog
                </Link>
                <Link href={"/projects"} className="bg-transparent text-black px-4 py-2 rounded-lg hover:bg-gray-200 transition dark:text-white">
                    Projects
                </Link>
                <Link href={"/about"} className="bg-transparent text-black px-4 py-2 rounded-lg hover:bg-gray-200 transition dark:text-white">
                    About
                </Link>
                {/*{path !== '/projects' && (*/}
                {/*)}*/}
